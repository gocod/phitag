      ...
      <div className="space-y-6">
        ...
        <div className="relative pl-8 border-l-2 border-blue-100">
          ...
          <p className="text-sm text-slate-500 mt-1">
            ...
            Name it <code className="bg-slate-200 px-1 rounded text-blue-700">PHItag-Connector</code> and select 
        ...
        <div className="relative pl-8 border-l-2 border-blue-100">
          ...
          <div className="mt-2 p-3 bg-amber-50 border border-amber-200 rounded-xl flex gap-3 items-start">
            ...
            <p className="text-[11px] text-amber-800 leading-relaxed font-medium">
              ...
              Azure masks this forever once you leave the page. This is your <strong>PHI-KEY</strong>.
            </p>
          </div>
        </div>
        ...
        <div className="relative pl-8 border-l-2 border-blue-100">
          <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-blue-200 border-4 border-white"></div>
          <h4 className="font-bold text-slate-900">Assign IAM Permissions</h4>
          <p className="text-sm text-slate-500 mt-1">
            Navigate to your <strong>Subscription</strong> → <strong>Access Control (IAM)</strong>. 
            Click <strong>Add role assignment</strong>. Assign the <strong>Reader</strong> or <strong>Tag Contributor</strong> 
            role to your "PHItag-Connector" app.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="flex-1">
       <div className="bg-slate-900 rounded-3xl p-8 text-emerald-400 font-mono text-xs shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <p className="pl-4">--scopes /subscriptions/{"{YOUR_ID}"}</p>
          </div>
       </div>
       <p className="text-[10px] text-slate-400 mt-4 text-center font-medium italic">
         Note: This grants PHI-tag permission to read and update tags only.
       </p>
    </div>
  </div>
</div>
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-slate-600 text-sm max-w-xl">Use our <strong>HIPAA Starter Template</strong> derived from your Manifesto. Upload this in your Registry to begin real-time drift detection[cite: 1, 3, 5].</p>
                </div>
                ...
                <div className="relative bg-slate-900 rounded-2xl p-6 overflow-hidden">
                  <div className="flex items-center justify-between mb-4 border-b border-slate-800 pb-4">
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2">
                      <FileJson size={14} className="text-blue-500" /> policy.json (HIPAA Standard)
                    </span>
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
             <div className="p-8 rounded-[2.5rem] bg-emerald-50 border border-emerald-100">
                ...
                <p className="text-xs text-slate-600 leading-relaxed font-medium">Verify your Azure credentials instantly. A green pulse indicates your BAA coverage and tag scanning is active.</p>
             </div>
             <div className="p-8 rounded-[2.5rem] bg-amber-50 border border-amber-100">
                ...
                <p className="text-xs text-slate-600 leading-relaxed font-medium">Configure Slack or Email notifications when a resource is created without mandatory tags like <strong>ContainsPHI</strong>[cite: 3].</p>
             </div>
          </div>
        </div>
      )}
      ...
      <div className="text-center pt-8 border-t border-slate-100">
        <p className="text-slate-400 text-sm">
          Need a custom BAA or specific technical assistance? <Link href="/support" className="text-blue-600 font-bold hover:underline">Contact Compliance Support</Link>
        </p>
      </div>
    </div>
  );
