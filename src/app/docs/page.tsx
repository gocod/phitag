    ...
    <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in duration-700 pb-20">
      ...
      {activeTab === 'help' ? (
        ...
        <div className="space-y-12 animate-in slide-in-from-bottom-4 duration-500">
          ...
          {/* STEP 3: POLICY ENGINE WORKFLOW (ADDED CONTENT) */}
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-slate-600 leading-relaxed font-medium">
                  The engine connects your local schema to live Azure resources. Ensure your IDs are entered in <strong>Settings</strong> before running these steps:
                </p>
                
                <div className="space-y-4">
                  <div className="flex gap-4 p-5 rounded-2xl border border-slate-100 bg-blue-50/50 shadow-sm">
                    <CloudSync className="text-blue-600 shrink-0" size={24} />
                    <div>
                      <h4 className="font-bold text-sm uppercase tracking-wide">1. Sync to Cloud</h4>
                      <p className="text-xs text-slate-500 leading-snug">Pulls a live inventory of all Azure Resource Groups and their current tagging metadata.</p>
                    </div>
                  </div>
                  <div className="flex gap-4 p-5 rounded-2xl border border-slate-100 bg-slate-50 shadow-sm">
                    <Save className="text-slate-700 shrink-0" size={24} />
                    <div>
                      <h4 className="font-bold text-sm uppercase tracking-wide">2. Save Policy</h4>
                      <p className="text-xs text-slate-500 leading-snug">Hardens your requirement logic (Step 2) into the engine's active configuration memory.</p>
                    </div>
                  </div>
                  <div className="flex gap-4 p-5 rounded-2xl border border-slate-100 bg-emerald-50 shadow-sm">
                    <Database className="text-emerald-600 shrink-0" size={24} />
                    <div>
                      <h4 className="font-bold text-sm uppercase tracking-wide">3. Deploy Config</h4>
                      <p className="text-xs text-slate-500 leading-snug">Activates the policy. Non-compliant assets are instantly flagged and updated in the Audit Vault.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 w-full bg-slate-50 rounded-3xl p-8 border border-slate-200">
                <h4 className="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-6 italic">Enforcement Logic Preview</h4>
                <div className="space-y-4 font-mono text-[13px]">
                  ...
                  <div className="p-4 bg-white rounded-xl border border-emerald-200 shadow-sm ml-6">
                    <span className="text-emerald-600 font-bold italic">REQUIRE</span> <span className="text-slate-700">HIPAAZone == "Secure"</span>
                  </div>
                </div>
                <div className="mt-8 p-6 bg-amber-50 rounded-2xl border border-amber-100">
                   ...
                   <p className="text-xs text-amber-900 leading-relaxed font-medium">Check the "Audit Vault" after deploying to view compliance drift across your subscriptions.</p>
                </div>
              </div>
            </div>
          </section>
